...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .info-card h2 { font-family: var(--font-display); font-weight: 800; font-stretch: 90%; font-size: 1.05rem; letter-spacing: -0.01em; text-transform: uppercase; flex-basis: 100%; }
        ...
        .info-row .maps-chip { margin-left: 2px; }
        ...
        .tag.tahun i { color: var(--blue); }
        .tag.plat i { color: var(--green); }
        ...
        .chip-muted { color: var(--steel); background: var(--paper); border: 1px solid var(--line); font-weight: 600; }
        ...
        @if(in_array(Auth::user()->role, ['sapra', 'user', 'super_user']))
            <details class="side-group" open>
                ...
                <div class="side-sub">
                    ...
                    <a href="/sapra/sarana-mako" class="active"><i class="fas fa-fire-extinguisher"></i> Sarana pemadam kebakaran</a>
    ...
    <main class="content">
        ...
        <div class="page-toolbar">
            <div>
                ...
                <p>Manajemen dokumentasi sarana kebakaran di Markas Komando dan Pos Pemadam.</p>
            </div>
            ...
            <div class="panel" id="panel-{{ $pos->id_pos }}" role="tabpanel" @if(!$isActive) hidden @endif @if($isActive) data-print-active @endif>
                ...
                <div class="info-card">
                    ...
                    <span class="info-row">
                        ...
                        @else
                            <span class="chip-muted" style="padding:5px 10px;border-radius:8px;">&mdash;</span>
                        @endif
                    </span>
                </div>
                        ...
                        <table class="data-table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:33%">Jenis sarana kebakaran</th>
                                    <th class="c" style="width:8%">Jumlah</th>
                                    <th style="width:27%">Gambar</th>
                                    <th class="c" style="width:12%">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @empty
                                <tr><td colspan="5" class="cell-empty">Belum ada data sarana untuk {{ $pos->nama_pos }}.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
...
(function () {
    ...
    /* ---------- Pencarian (hanya di panel aktif) ---------- */
    if (searchInput) {
