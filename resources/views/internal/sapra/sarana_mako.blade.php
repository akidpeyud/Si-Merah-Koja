...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .toast-ico { flex: none; width: 28px; height: 28px; border-radius: 50%; display: grid; place-items: center; color: #fff; font-size: .78rem; background: var(--green); }        .toast.err .toast-ico { background: var(--signal); }
        ...
        @if(in_array(Auth::user()->role, ['sapra', 'user', 'super_user']))
            <details class="side-group" {{ Request::is('sapra*') ? 'open' : '' }}>
                ...
                <div class="side-sub">
                    ...
                    <!-- ACTIVE KARENA INI HALAMAN SARANA MAKO -->
                    <a href="/sapra/sarana-mako" class="side-a active"><i class="fas fa-fire-extinguisher"></i> Sarana pemadam kebakaran</a>
    ...
    <main class="content">
        ...
        <div class="page-toolbar">
            <div>
                ...
                <p>Manajemen dokumentasi visual sarana pemadam kebakaran di Pos Pemadam.</p>
            </div>
                    ...
                    <div class="table-scroll">
                        <table class="data-table">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="5" class="cell-empty">Belum ada data sarana untuk {{ $pos->nama_pos }}.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
