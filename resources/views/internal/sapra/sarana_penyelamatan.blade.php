...
<head>
    ...
    <style>
        /* ==========================================================
           TOKENS & BASE (MASTER DESIGN — sama seperti Data Prasarana)
           ========================================================== */
        :root {
    ...
    <main class="content">
        ...
        <div class="page-toolbar">
            ...
            <div class="toolbar-actions">
                <label class="search">
                    <span class="sr-only" style="position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0);">Cari sarana penyelamatan</span>
                                ...
                                <tr class="data-row" data-tab="{{ $pos->id_pos }}">
                                    ...
                                    <td class="c">
                                        <div class="row-actions">
                                            ...
                                            <form action="/sapra/sarana-penyelamatan/delete/{{ $item->id_sarana_penyelamatan }}" method="POST" style="margin:0;" onsubmit="return confirm('Yakin ingin menghapus sarana ini? Gambar akan ikut terhapus permanen.');">
                                                @csrf @method('DELETE')
