        ...
        @if(in_array(Auth::user()->role, ['sapra', 'user', 'super_user']))
            ...
            <details class="side-group" open>
                ...
                <div class="side-sub">
                    ...
                    <!-- ACTIVE ADA DI SINI KARENA INI HALAMAN SARANA PEMERIKSAAN -->
                    <a href="/sapra/sarana-pemeriksaan" class="active"><i class="fas fa-search"></i> Sarana pemeriksaan proteksi kebakaran</a>
    ...
    <main class="content">
        ...
        @foreach($posPemadam as $pos)
            @php
                ...
                // Filter menggunakan data Pemeriksaan
                                ...
                                <tr class="data-row">
                                    ...
                                    <td class="c">
                                        <div class="row-actions">
                                            ...
                                            <form action="/sapra/sarana-pemeriksaan/delete/{{ $item->id_sarana_pemeriksaan }}" method="POST" style="margin:0;" onsubmit="return confirm('Yakin ingin menghapus sarana pemeriksaan ini?');">
                                                @csrf @method('DELETE')
