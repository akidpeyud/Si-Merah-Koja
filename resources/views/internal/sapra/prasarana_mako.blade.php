...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cell-name { font-weight: 700; font-size: .92rem; text-transform: uppercase; margin-bottom: 8px; }
        ...
        @if(in_array(Auth::user()->role, ['sapra', 'user', 'super_user']))
            ...
            <details class="side-group" open>
                ...
                <div class="side-sub">
                    ...
                    <a href="/sapra/prasarana-mako" class="active"><i class="fas fa-building"></i> Prasarana pemadam kebakaran</a>
