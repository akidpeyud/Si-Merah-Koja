...
<body>
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <a href="/sapra/prasarana-mako" class="sidebar-item active"><i class="fas fa-building"></i> Prasarana Mako & Pos</a>
                                                    ...
                                                    @if($item->path_gambar)
                                                        <div class="img-wrapper">
                                                            <a href="{{ asset($item->path_gambar) }}" target="_blank">
                                                                <img src="{{ asset($item->path_gambar) }}" alt="{{ $item->jenis_prasarana }}" class="img-prasarana" onerror="this.src='https://via.placeholder.com/200x130?text=Gambar+Hilang'">
                                                            </a>
                                                        </div>
                                                    @else
