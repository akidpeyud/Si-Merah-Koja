        ...
        @if(in_array(Auth::user()->role, ['sapra', 'user', 'super_user']))
            ...
            <details class="side-group" open>
                ...
                <div class="side-sub">
                    ...
                    <a href="/sapra/kelola-pos" class="active"><i class="fas fa-warehouse"></i> Kelola data pos</a>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr class="data-row">
                            ...
                            <td>
                                <div class="data-address" style="color: var(--steel); font-size: .9rem; line-height: 1.5;">{{ $item->alamat ?? '-' }}</div>
                            </td>
                            <td class="c">
                                @if($item->kode_map)
