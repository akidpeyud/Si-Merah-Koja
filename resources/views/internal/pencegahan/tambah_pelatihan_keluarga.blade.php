...
<head>
    ...
    <title>Tambah Data Pelatihan Keluarga - SIMERAH KOJA</title>
                    ...
                    <form action="{{ route('pelatihan_keluarga.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <!-- Menggunakan type="date" agar muncul kalender pop-up -->
                                <input type="date" class="form-control" name="tanggal_pelaksanaan" required>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Kecamatan</label>
                                <input type="text" class="form-control" name="kecamatan" placeholder="Contoh: Jambi Timur" required>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Kelurahan</label>
                                <input type="text" class="form-control" name="kelurahan" placeholder="Contoh: Kasang Jaya" required>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">RT</label>
                                <input type="text" class="form-control" name="rt" placeholder="Contoh: 01, 03, 05, 06" required>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Posyandu (Opsional)</label>
                                <input type="text" class="form-control" name="posyandu" placeholder="Contoh: Posyandu Melati (Boleh dikosongkan)">
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4 pt-3" style="border-top: 1px solid #e2e8f0;">
                            ...
                            <button type="submit" class="btn btn-save"><i class="fas fa-save me-2"></i> Simpan Data Pelatihan</button>
                        </div>
                    </form>
                </div>
            </main>
