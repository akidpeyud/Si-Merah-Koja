...
<head>
    ...
    <title>Detail Pembinaan - SIMERAH KOJA</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <h1 class="mt-2" style="font-weight: 800; color: #0f172a;">Rincian Pembinaan & Pengembangan</h1>
            </div>

            <!-- AREA CETAK PDF -->
            <div class="pdf-container" id="area-cetak-pdf">
                <h4 class="mb-4" style="font-weight: 800; color: #0f172a; border-left: 4px solid #3b82f6; padding-left: 12px;">Informasi Kegiatan</h4>
                
                <div class="detail-row">
                    <div class="detail-label"><i class="fas fa-chart-line text-primary"></i> Nama Kegiatan</div>
                    <div class="detail-value">: {{ $data->nama_program ?? '-' }}</div>
                </div>
                ...
                <div class="detail-row">
                    <div class="detail-label"><i class="fas fa-users text-primary"></i> Sasaran Peserta</div>
                    <div class="detail-value">: {{ $data->sasaran_pembinaan ?? '-' }}</div>
                </div>

                <div class="detail-row">
                    <div class="detail-label"><i class="fas fa-user-plus text-primary"></i> Jumlah Peserta</div>
                    <div class="detail-value">: {{ $data->target_peserta ?? '0' }} Orang</div>
                </div>
                ...
                <div class="detail-row">
                    <div class="detail-label"><i class="fas fa-file-archive text-danger"></i> Dokumen Pendukung</div>
                    <div class="detail-value">
                        ...
                        @if(isset($data->dokumen_pendukung) && $data->dokumen_pendukung)
                            ...
                            <a href="{{ asset('uploads/pembinaan/' . $data->dokumen_pendukung) }}" target="_blank" class="btn btn-sm btn-outline-primary rounded-pill px-3 ms-2" data-html2canvas-ignore="true" style="font-weight: 600;">
                    ...
                    @if($isImage)
                        <div class="mt-5 pt-4" style="border-top: 2px dashed #cbd5e1; page-break-inside: avoid;">
                            <h5 class="mb-4" style="font-weight: 800; color: #1e293b;">
                                <i class="fas fa-camera text-primary me-2"></i> Dokumentasi Kegiatan
                            </h5>
                            <div class="text-center p-3" style="background-color: #f1f5f9; border-radius: 12px;">
                                <img src="{{ asset('uploads/pembinaan/' . $data->dokumen_pendukung) }}" crossorigin="anonymous" alt="Dokumentasi" style="max-height: 450px; width: auto; max-width: 100%; object-fit: contain; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
                            </div>
                        </div>
                    @endif
                @endif
            ...
            <div class="d-flex justify-content-end gap-3 mt-4">
                ...
                <a href="/internal/pencegahan/pembinaan-pengembangan/edit/{{ $data->id }}" class="btn btn-warning px-4 py-2 text-white" style="border-radius: 8px; font-weight: 600;">
    ...
    <script>
        function downloadLaporanPDF() {
            ...
            const opt = {
                ...
                filename:     'Data_Pembinaan_{{ str_replace(" ", "_", $data->nama_program ?? "Laporan") }}.pdf',
