...
<body>
    <nav class="navbar-internal">
        ...
        <div class="user-menu">
            ...
            <a href="/internal/pencegahan/layanan-inspeksi" class="btn btn-outline-light btn-sm" style="border-radius: 8px; font-weight: 600;"><i class="fas fa-arrow-left me-1"></i> Kembali</a>
        </div>
    </nav>
