...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .table-custom { margin-bottom: 0; width: 100%; min-width: 1000px; } 
        ...
        /* Khusus Header Tabel Bersarang */
        .th-group { text-align: center; border-bottom: 1px solid #334155 !important; }
        
        /* Baris Total */
        .row-total { background-color: #f8fafc; font-weight: 800; border-top: 2px solid #cbd5e1; }
        
        /* Judul Tabel */
        .table-heading { font-size: 16px; font-weight: 800; color: #0f172a; margin-top: 40px; margin-bottom: 5px; display: flex; align-items: center; gap: 8px; }
    </style>
</head>
<body>
        ...
        <main class="main-content">
            ...
            <div class="d-flex justify-content-between align-items-end mb-3 flex-wrap gap-3">
                <div>
                    ...
                    <p class="text-muted mb-0" style="font-size: 15px;">Kelola data instansi pemerintah / swasta yang melaksanakan pelatihan pemadam kebakaran.</p>
                </div>
            ...
            <!-- ============================================== -->
            <!-- TABEL 1: FORMAT 2025 - 2026 (RINCIAN GENDER) -->
            <!-- ============================================== -->
            <h5 class="table-heading mt-4 text-success"><i class="fas fa-calendar-check"></i> Data Fire Drill Tahun 2025 & 2026</h5>
                    ...
                    <table class="table table-hover table-custom">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="text-center bg-secondary" width="90px">TOTAL</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
            ...
            <!-- ============================================== -->
            <!-- TABEL 2: FORMAT 2023 - 2024 (TOTAL SAJA) -->
            <!-- ============================================== -->
            <h5 class="table-heading text-warning"><i class="fas fa-history"></i> Data Fire Drill Tahun 2023 & 2024</h5>
            <div class="table-wrapper">
                <div class="table-responsive">
                    <table class="table table-hover table-custom">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="150px">JUMLAH PESERTA</th>
