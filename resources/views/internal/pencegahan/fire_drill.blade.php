...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-logout { display: inline-flex; align-items: center; gap: 8px; height: 40px; padding: 0 18px; border-radius: 999px; background: var(--navy); color: #fff; font-weight: 600; font-size: .85rem; border: none; }
        ...
        .side-link { display: flex; align-items: center; gap: 14px; padding: 11px 14px; border-radius: var(--r-sm); font-size: .9rem; font-weight: 600; color: var(--ink); margin-bottom: 4px; }
        ...
        .side-group summary { list-style: none; cursor: pointer; display: flex; align-items: center; gap: 12px; padding: 11px 14px; border-radius: var(--r-sm); font-size: .8rem; font-weight: 700; letter-spacing: .04em; text-transform: uppercase; color: var(--navy); }
        ...
        .side-sub a { display: flex; align-items: center; gap: 12px; padding: 9px 12px; border-radius: var(--r-sm); font-size: .85rem; font-weight: 500; line-height: 1.4; color: var(--steel); }
        ...
        .custom-nav-tabs .nav-link { border: none; color: var(--steel); font-weight: 700; font-size: 13px; padding: 12px 18px; background: transparent; white-space: nowrap; }
        .custom-nav-tabs .nav-link.active { color: var(--navy); border-bottom: 3px solid var(--navy); }

        /* HEADER TABEL */
        .section-heading { display: flex; align-items: center; gap: 12px; margin-bottom: 16px; margin-top: 36px; flex-wrap: nowrap; }
        ...
        .section-heading h3 { flex: none; font-family: var(--font-display); font-weight: 700; font-stretch: 90%; font-size: 1.1rem; color: var(--ink); letter-spacing: -0.01em; margin: 0; }
        ...
        .badge-tahun { background: var(--navy-tint); color: var(--navy); padding: 4px 8px; border-radius: 4px; font-weight: 700; font-size: 10px; margin-top: 4px; display: inline-block; }
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <details class="side-group" open>
            ...
            <div class="side-sub">
                ...
                <a href="/internal/pencegahan/inspeksi-kebakaran" class="active"><i class="fas fa-magnifying-glass-chart"></i> Pencegahan Kebakaran dan Inspeksi</a>
    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between align-items-end mb-4 flex-wrap gap-3">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="{{ route('fire_drill.create') }}" class="btn text-white fw-bold d-flex align-items-center gap-2" style="background-color: var(--navy); padding: 9px 16px; border-radius: 8px;">
        ...
        <ul class="nav custom-nav-tabs">
            <li class="nav-item"><a class="nav-link" href="/internal/pencegahan/inspeksi-kebakaran">Semua Data</a></li>
            <li class="nav-item"><a class="nav-link" href="/internal/pencegahan/inspeksi-kebakaran/bangunan">INSPEKSI BANGUNAN GEDUNG DAN LINGKUNGAN</a></li>
            <li class="nav-item"><a class="nav-link active" href="/internal/pencegahan/inspeksi-kebakaran/fire-drill">FIRE DRILL</a></li>
        </ul>

        <!-- ================= TABEL 1: 2025 - 2026 ================= -->
        <div class="section-heading">
            <span class="section-heading-ico"><i class="fas fa-calendar-check"></i></span>
            <h3>Data Fire Drill Tahun 2025 & 2026</h3><span class="line"></span>
        </div>
            ...
            <table class="table-detailed table-hover">
                <thead>
                    <tr>
                        ...
                        <th colspan="3" class="text-center" style="border-bottom: 1px solid var(--ink-3);">JUMLAH PESERTA</th>
                    ...
                    <tr>
                        ...
                        <th class="text-center" width="90px" style="background: rgba(255,255,255,0.1);">TOTAL</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center fw-bold" style="color: var(--navy);">{{ $item->total_peserta }}</td>
                        <td class="text-center d-flex justify-content-center gap-1">
                            <a href="{{ route('fire_drill.edit', $item->id) }}" class="btn-action btn-edit" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('fire_drill.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?');" style="margin: 0; display: inline-block;">
                                @csrf @method('DELETE')
        ...
        <div class="section-heading mt-5">
            <span class="section-heading-ico" style="background-color: var(--amber);"><i class="fas fa-history"></i></span>
            <h3>Data Fire Drill Tahun 2023 & 2024</h3><span class="line"></span>
        </div>
            ...
            <table class="table-detailed table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- Perbaikan HTML <tbody>: Digabung jadi 1 kolom Total sesuai header -->
                        <td class="text-center fw-bold" style="color: var(--navy);">{{ $item->total_peserta }} Orang</td>
