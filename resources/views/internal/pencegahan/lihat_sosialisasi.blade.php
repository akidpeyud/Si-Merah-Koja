...
<head>
    ...
    <title>Detail Sosialisasi - SIMERAH KOJA</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .nav-brand .title { font-weight: 800; font-size: 18px; }
...
<body>
    <nav class="navbar-internal">
        ...
        <a href="/internal/pencegahan/layanan-sosialisasi" class="btn btn-outline-light btn-sm" style="border-radius: 8px; font-weight: 600;">Kembali</a>
    </nav>

    <div class="dashboard-container">
        <!-- SIDEBAR -->
        <aside class="sidebar">
            <div class="mt-4 mb-2 ms-3" style="font-size: 11px; font-weight: 800; color: #94a3b8; text-transform: uppercase;">Bagian Pencegahan</div>
        ...
        <main class="main-content">
            <div class="page-header">
                <a href="/internal/pencegahan/layanan-sosialisasi" class="text-decoration-none" style="color: #64748b; font-size: 14px; font-weight: 600;"><i class="fas fa-arrow-left me-2"></i> Kembali</a>
                <h1 class="mt-2">Rincian Data Sosialisasi</h1>
            </div>

            <!-- AREA CETAK PDF -->
            <div class="pdf-container" id="area-cetak-pdf">
                <h4 class="mb-4" style="font-weight: 800; color: #0f172a; border-left: 4px solid #3b82f6; padding-left: 12px;">Informasi Sosialisasi</h4>
                
                <div class="detail-row">
                    <div class="detail-label"><i class="fas fa-bullhorn text-primary"></i> Nama Kegiatan</div>
                ...
                <div class="detail-row">
                  <div class="detail-label"><i class="fas fa-users text-primary"></i> Sasaran / Kategori Peserta</div>
                  <!-- Ganti variabelnya jadi sasaran_peserta -->
                  <div class="detail-value">: {{ $data->sasaran_peserta ?? '-' }}</div>
                  </div>
                ...
                <div class="detail-row">
                    <div class="detail-label"><i class="fas fa-file-archive text-danger"></i> Dokumen Lampiran</div>
                    <div class="detail-value">
                        ...
                        @if(isset($data->surat_permohonan) && $data->surat_permohonan)
                            ...
                            <a href="{{ asset('uploads/sosialisasi/' . $data->surat_permohonan) }}" target="_blank" class="btn btn-sm btn-outline-primary rounded-pill px-3 ms-2" data-html2canvas-ignore="true" style="font-weight: 600;">
                ...
                @if(isset($data->surat_permohonan) && $data->surat_permohonan)
                    @php
                        $ext = strtolower(pathinfo($data->surat_permohonan, PATHINFO_EXTENSION));
                    ...
                    @if($isImage)
                        <div class="mt-5 pt-4" style="border-top: 2px dashed #cbd5e1; page-break-inside: avoid;">
                            <h5 class="mb-4" style="font-weight: 800; color: #1e293b;">
                                <i class="fas fa-camera text-primary me-2"></i> Lampiran Foto
                            </h5>
                            <div class="text-center p-3" style="background-color: #f1f5f9; border-radius: 12px;">
                                <img src="{{ asset('uploads/sosialisasi/' . $data->surat_permohonan) }}" crossorigin="anonymous" alt="Dokumentasi" style="max-height: 450px; width: auto; max-width: 100%; object-fit: contain; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
                            </div>
                        </div>
                    @endif
                @endif
            ...
            <div class="d-flex justify-content-end gap-3 mt-4">
                ...
                <a href="/internal/pencegahan/layanan-sosialisasi/edit/{{ $data->id }}" class="btn btn-warning px-4 py-2 text-white" style="border-radius: 8px; font-weight: 600;">
    ...
    <script>
        function downloadLaporanPDF() {
            ...
            const opt = {
                ...
                filename:     'Data_Sosialisasi_{{ str_replace(" ", "_", $data->nama_kegiatan ?? "Laporan") }}.pdf',
