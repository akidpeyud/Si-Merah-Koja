...
<head>
    ...
    <title>Edit Data Fire Drill - SIMERAH KOJA</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <main class="main-content">
                ...
                <h1 class="fw-bolder text-dark mb-0" style="font-size: 24px;">Form Edit Data Fire Drill</h1>

                <div class="form-wrapper">
                    <!-- Ingat, edit data wajib pakai PUT -->
                    <form action="{{ route('fire_drill.update', $item->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="nama_instansi" value="{{ $item->nama_instansi }}" required>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="tanggal_pelaksanaan" value="{{ $item->tanggal_pelaksanaan }}" required>
                            </div>

                            <div class="col-md-12">
                                <label class="form-label">Tempat Pelaksanaan</label>
                                <input type="text" class="form-control" name="tempat_pelaksanaan" value="{{ $item->tempat_pelaksanaan }}" required>
                            </div>
                        </div>
