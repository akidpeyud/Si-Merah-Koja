...
<head>
    ...
    <title>DIKSAR - SIMERAH KOJA</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-action { width: 32px; height: 32px; display: inline-flex; justify-content: center; align-items: center; border-radius: 6px; font-size: 13px; color: white; border: none; cursor: pointer; transition: transform 0.1s; margin-right: 2px;}
    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between align-items-end mb-4 flex-wrap gap-3">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <!-- TOMBOL TAMBAH, EXCEL, DAN PDF KHUSUS DIKSAR -->
                <a href="/internal/pencegahan/peningkatan-kapasitas/tambah?jenis=DIKSAR" class="btn text-white fw-bold d-flex align-items-center gap-2" style="background-color: var(--navy); padding: 9px 16px;">
                    <i class="fas fa-plus"></i> Tambah Data
                </a>
                <a href="/internal/pencegahan/peningkatan-kapasitas/cetak-excel/diksar" class="btn text-white fw-bold d-flex align-items-center gap-2" style="background-color: var(--success); padding: 9px 16px;">
                    <i class="fas fa-file-excel"></i> Excel
                </a>
                <a href="/internal/pencegahan/peningkatan-kapasitas/cetak-pdf/diksar" target="_blank" class="btn text-white fw-bold d-flex align-items-center gap-2" style="background-color: var(--signal); padding: 9px 16px;">
        ...
        <h5 class="fw-bold mt-4 mb-3" style="color: var(--navy);">
            <i class="fas fa-list-check me-2"></i> Data DIKSAR
        </h5>
            ...
            <table class="table-detailed table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge-diklat">{{ $item->jenis_diklat ?? 'DIKSAR' }}</span></td>
                        ...
                        <td class="text-center d-flex justify-content-center gap-1">
                            <a href="/internal/pencegahan/peningkatan-kapasitas/edit/diksar/{{ $item->id }}" class="btn-action btn-edit" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="/internal/pencegahan/peningkatan-kapasitas/hapus/diksar/{{ $item->id }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?');" style="display:inline-block;">
                                @csrf
                                @method('DELETE')
