...
<head>
    ...
    <title>Layanan Inspeksi - SIMERAH KOJA</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="page-header d-flex justify-content-between align-items-end">
                <div>
                    <h1>Data Layanan Inspeksi</h1>
                    <p>Kelola dan pantau seluruh laporan jadwal dan hasil inspeksi.</p>
                </div>
                
                <a href="/internal/pencegahan/layanan-inspeksi/tambah" class="btn btn-primary px-4 py-2" style="border-radius: 10px; font-weight: 600; box-shadow: 0 4px 12px rgba(37, 99, 235, 0.2); text-decoration: none;">
                    <i class="fas fa-plus me-2"></i> Tambah Inspeksi Baru
                </a>
            ...
            <div class="content-card">
                <div class="card-toolbar">
                    <div class="search-box">
                        ...
                        <input type="text" placeholder="Cari nama bangunan atau lokasi...">
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-custom w-100">
                        <thead>
                            <tr>
                                <th width="5%">No</th>
                                <th width="15%">Tanggal Inspeksi</th>
                                <th width="30%">Nama Bangunan / Lokasi</th>
                                <th width="20%">Petugas Lapangan</th>
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td><span class="title-text">12 Sep 2026</span></td>
                                <td>
                                    <span class="title-text">Hotel Abadi Jambi</span>
                                    <span class="sub-text">Jl. Gatot Subroto No. 1</span>
                                </td>
                                <td><span class="title-text">Tim Alpha</span><span class="sub-text">3 Personil</span></td>
                                <td><span class="badge-soft-warning"><i class="fas fa-clock me-1"></i> Menunggu Jadwal</span></td>
                            ...
                            <tr>
                                <td>2</td>
                                <td><span class="title-text">10 Sep 2026</span></td>
                                <td>
                                    <span class="title-text">Pabrik Karet PT ABC</span>
                                    <span class="sub-text">Kawasan Industri Talang Gulo</span>
                                </td>
                                <td><span class="title-text">Tim Bravo</span><span class="sub-text">4 Personil</span></td>
                                <td><span class="badge-soft-success"><i class="fas fa-check-circle me-1"></i> Selesai (Aman)</span></td>
                                <td class="text-center">
                                    <button class="btn-action btn-action-view" title="Lihat Detail"><i class="fas fa-eye"></i></button>
                                    <button class="btn-action btn-action-edit" title="Edit Data"><i class="fas fa-edit"></i></button>
                                </td>
