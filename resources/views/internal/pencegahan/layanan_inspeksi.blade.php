        ...
        <main class="main-content">
            <div class="page-header d-flex justify-content-between align-items-end">
                <div>
                    ...
                    <p>Kelola data inspeksi keselamatan kebakaran pada gedung dan bangunan.</p>
                </div>
            ...
            <div class="content-card">
                <div class="card-toolbar">
                    <div class="search-box">
                        ...
                        <input type="text" id="searchInput" placeholder="Cari nama objek atau lokasi...">
                    </div>
                    <div class="dropdown">
                ...
                <div class="table-responsive">
                    <table class="table table-custom w-100">
                        <thead>
                            <tr>
                                <th width="5%">No</th>
                                <th width="20%">Tanggal Inspeksi</th>
                                <th width="35%">Objek Inspeksi</th>
