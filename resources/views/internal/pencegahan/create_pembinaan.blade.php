...
<head>
    ...
    <title>Tambah Program Pembinaan - SIMERAH KOJA</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <h1 class="mt-2">Form Program Pembinaan Baru</h1>
            </div>
            ...
            <div class="form-card">
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="form-label"><i class="fas fa-chart-line text-primary"></i> Nama Program / Kegiatan</label>
                            <input type="text" class="form-control" name="nama_program" placeholder="Contoh: Pembinaan Rutin Posko Damkar" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label"><i class="fas fa-map-marked-alt text-primary"></i> Lokasi / Tempat Pelaksanaan</label>
                            <input type="text" class="form-control" name="lokasi" placeholder="Contoh: Posko Damkar Wilayah Timur" required>
                        </div>
                    </div>

                    <div class="row mb-4">
                        <div class="col-md-4">
                            <label class="form-label"><i class="fas fa-calendar-check text-primary"></i> Tanggal Pelaksanaan</label>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="form-label"><i class="fas fa-users-cog text-primary"></i> Sasaran Pembinaan</label>
                            <select class="form-select" name="sasaran_pembinaan" required>
                                <option value="" disabled selected>Pilih Sasaran...</option>
                                <option value="Anggota Posko">Anggota Posko Damkar</option>
                                <option value="Relawan REDKAR">Relawan REDKAR</option>
                                <option value="Satgas Kebakaran">Satgas Kebakaran</option>
                                <option value="Lainnya">Lainnya</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label"><i class="fas fa-user-check text-primary"></i> Target Jumlah Peserta</label>
                            <div class="input-group">
                                <input type="number" class="form-control" name="target_peserta" min="1" placeholder="Misal: 30" required>
                                <span class="input-group-text" style="background-color: #e2e8f0; border: none; font-weight: 600; color: #475569;">Orang</span>
                            </div>
                        </div>
                    </div>

                    <!-- KOTAK UPLOAD DOKUMEN PENDUKUNG -->
                    <div class="mb-4 p-4" style="background-color: #f1f5f9; border-radius: 12px; border: 1px dashed #94a3b8;">
                        <label class="form-label mb-2"><i class="fas fa-file-alt text-danger"></i> Dokumen Acuan / Surat Tugas (Opsional)</label>
                        <input class="form-control" type="file" name="dokumen_pendukung" accept=".pdf, .doc, .docx, .jpg, .png">
                        <small class="text-muted" style="font-size: 13px; margin-top: 8px; display: block;">
                            <i class="fas fa-info-circle me-1"></i> Upload file Kerangka Acuan Kerja (KAK) atau Surat Tugas. Format: PDF, Word, JPG, PNG (Maks. 5MB).
                        </small>
                    </div>

                    <div class="mb-4">
                        <label class="form-label"><i class="fas fa-clipboard-list text-primary"></i> Fokus/Materi Pembinaan (Catatan Tambahan)</label>
                        <textarea class="form-control" name="catatan" rows="3" placeholder="Misal: Fokus pada pengecekan rutin unit pemadam dan kesiapsiagaan personel regu piket..."></textarea>
                    </div>
