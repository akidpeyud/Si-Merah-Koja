...
<head>
    ...
    <title>Diklat F1 - SIMERAH KOJA</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .table-custom {
            margin-bottom: 0;
            width: 100%;
            min-width: 2800px; /* Diperlebar ekstrim biar muat 21 kolom excel tanpa nabrak */
        }
        ...
        .table-custom thead th {
            ...
            border: none;
            border-right: 1px solid #334155 !important; /* Biar keliatan batas antar kolom kayak excel */
        ...
        .table-custom tbody td {
            ...
            border-right: 1px solid #f1f5f9; /* Garis vertikal pembatas */
            white-space: nowrap;
        }
