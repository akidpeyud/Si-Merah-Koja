...
<head>
    ...
    <title>Diklat MFR - SIMERAH KOJA</title>
        ...
        <main class="main-content">
            ...
            <div class="d-flex justify-content-between align-items-end mb-3 flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="/internal/pencegahan/peningkatan-kapasitas/tambah?jenis=DIKLAT MFR" class="btn text-white fw-bold d-flex align-items-center gap-2" style="background-color: #0284c7; padding: 9px 16px;">
            ...
            <ul class="nav custom-nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/internal/pencegahan/peningkatan-kapasitas/diklat-mfr">DIKLAT MFR</a>
                </li>
                <li class="nav-item">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="sticky-action text-center" style="white-space: nowrap;">
                                    ...
                                    <a href="/internal/pencegahan/peningkatan-kapasitas/edit/diklat-mfr/{{ $item->id }}" class="btn-action btn-edit" title="Edit Data" style="position: relative; z-index: 10;">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    
                                    <form action="/internal/pencegahan/peningkatan-kapasitas/hapus/diklat-mfr/{{ $item->id }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                        @csrf 
                                        @method('DELETE')
