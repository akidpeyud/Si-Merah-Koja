        ...
        @if(Auth::user()?->role === 'user' || Auth::user()?->role === 'super_user' || true)
            ...
            <details class="side-group" {{ Request::is('internal/pencegahan*') ? 'open' : '' }}>
                ...
                <div class="side-sub">
                    ...
                    <a href="/internal/pencegahan/inspeksi-kebakaran" class="active">
    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between align-items-end mb-4 flex-wrap gap-3">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="/internal/pencegahan/inspeksi-kebakaran/bangunan/tambah" class="btn text-white fw-bold d-flex align-items-center gap-2" style="background-color: var(--navy); padding: 9px 16px;">
                    <i class="fas fa-plus"></i> Tambah Data
                </a>
                <a href="/internal/pencegahan/inspeksi-kebakaran/bangunan/cetak-excel" class="btn text-white fw-bold d-flex align-items-center gap-2" style="background-color: var(--success); padding: 9px 16px;">
                    <i class="fas fa-file-excel"></i> Excel
                </a>
                <a href="/internal/pencegahan/inspeksi-kebakaran/bangunan/cetak-pdf" target="_blank" class="btn text-white fw-bold d-flex align-items-center gap-2" style="background-color: var(--signal); padding: 9px 16px;">
        ...
        <ul class="nav custom-nav-tabs">
            <li class="nav-item">
                <a class="nav-link {{ Request::is('internal/pencegahan/inspeksi-kebakaran') && !Request::is('internal/pencegahan/inspeksi-kebakaran/*') ? 'active' : '' }}" href="/internal/pencegahan/inspeksi-kebakaran">
                    Semua Data
                </a>
            </li>
            <li class="nav-item">
        ...
        <h5 class="fw-bold mt-4 mb-3" style="color: var(--navy);">
            <i class="fas fa-building-circle-check me-2"></i> Data Inspeksi Bangunan & Lingkungan
        </h5>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center d-flex justify-content-center gap-1">
                            ...
                            <form action="{{ route('inspeksi.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?');" style="display:inline-block;">
                                @csrf
                                @method('DELETE')
