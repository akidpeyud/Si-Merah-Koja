...
<!-- Tambahan Script khusus efek Hover di Card Baru -->
<script>
    document.querySelectorAll('.media-card').forEach(card => {
        card.addEventListener('mouseenter', () => {
            const linkIcon = card.querySelector('.media-body a i');
            const title = card.querySelector('h3');
            if (linkIcon) linkIcon.style.transform = 'translateX(4px)';
            if (title) title.style.color = 'var(--signal-d)';
        });
        card.addEventListener('mouseleave', () => {
            const linkIcon = card.querySelector('.media-body a i');
            const title = card.querySelector('h3');
            if (linkIcon) linkIcon.style.transform = 'translateX(0)';
