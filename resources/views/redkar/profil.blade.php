    ...
    <main class="page-wrapper">
        <div class="container profile-container">
            ...
            <div class="page-header">
                <a href="/redkar/dashboard" class="btn-back" title="Kembali ke Dashboard">
                    <i class="fas fa-arrow-left"></i>
                </a>
                <div class="page-header-text">
                    <h1>Profil Saya</h1>
                    <p>Informasi data dan keanggotaan relawan REDKAR.</p>
                </div>
            </div>
                ...
                <div class="profile-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 pe-md-4">
                            ...
                            <div class="info-group">
                                <div class="info-label">Jenis Kelamin & Agama</div>
                                <div class="info-value">
                                    {{ $user->jenis_kelamin }}
                        ...
                        <div class="col-md-6 ps-md-4 profile-column-right">
                            <h4 class="section-title">
                                <i class="fas fa-location-dot"></i> Wilayah & Pekerjaan
                            </h4>

                            <div class="info-group">
                                <div class="info-label">Alamat Lengkap</div>
                                <div class="info-value">
                                    {{ $user->alamat }}, RT/RW {{ $user->rt_rw }}
                                </div>
                            </div>
                            ...
                            <div class="document-box">
                                <div class="document-info">
                                    ...
                                    <div>
                                        ...
                                        <p>Dokumen KTP yang terdaftar pada sistem.</p>
                                    </div>
                                </div>
                                <a href="{{ asset('storage/' . $user->file_ktp) }}" target="_blank" class="btn-view-ktp">
                    ...
                    <div class="alert-info-custom">
                        ...
                        <div>
                            <strong>Informasi Data Terkunci</strong>
                            <br>
                            Untuk menjaga validitas keanggotaan, data profil tidak dapat diubah secara mandiri. Jika terdapat kesalahan data, silakan hubungi Admin Disdamkartan Kota Jambi.
                        </div>
                    </div>
