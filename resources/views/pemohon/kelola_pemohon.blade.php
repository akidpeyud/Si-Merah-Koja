...
<head>
    ...
    <!-- Bootstrap Khusus untuk Tabel dan Modal -->
...
<div class="shell">
    ...
    <aside class="sidebar" id="sidebar" aria-label="Navigasi internal">
        ...
        @if(Auth::user()->role === 'user' || Auth::user()->role === 'super_user')
            ...
            <details class="side-group" {{ Request::is('internal/kepegawaian*') ? 'open' : '' }}>
                ...
                <div class="side-sub">
                    <a href="/internal/kepegawaian/duk" class="{{ Request::is('internal/kepegawaian/duk*') ? 'active' : '' }}"><i class="fas fa-users-tie"></i> Data Urut Kepegawaian</a>
                </div>
            </details>
            ...
            <details class="side-group" {{ Request::is('sapra*') ? 'open' : '' }}>
                ...
                <div class="side-sub">
                    ...
                    <a href="/sapra/data_hidrant_gedung" class="{{ Request::is('sapra/data_hidrant_gedung*') ? 'active' : '' }}"><i class="fas fa-clipboard-list"></i> Sumber Air</a>
        ...
        <details class="side-group" {{ Request::is('internal/profil*') || Request::is('internal/kelola-user*') || Request::is('internal/kelola-pemohon*') ? 'open' : '' }}>
            ...
            <div class="side-sub">
                ...
                @if(Auth::user()->role === 'super_user')
                    <a href="/internal/kelola-user" class="{{ Request::is('internal/kelola-user*') ? 'active' : '' }}"><i class="fas fa-users"></i> Kelola Semua Pengguna</a>
                    
                    <!-- MENU KELOLA AKUN PEMOHON -->
                    <a href="/internal/kelola-pemohon" class="active"><i class="fas fa-users-viewfinder"></i> Kelola Akun Pemohon</a>
                @endif
            </div>
        </details>
    </aside>
    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between align-items-end mb-4 flex-wrap gap-3">
            ...
            <button type="button" class="btn-tambah" data-bs-toggle="modal" data-bs-target="#modalPemohon">
                <i class="fas fa-plus me-1"></i> Tambah Akun Manual
            </button>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered align-middle">
                    ...
                    <tbody>
                        <!-- CONTOH LOOPING DATA -->
                        @php 
                            // Pastikan variabel $pemohons dikirim dari Controller. Ini hanya fallback.
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="badge bg-primary">{{ ucfirst($pemohon->role ?? 'Pemohon') }}</span>
                            </td>
                            <td class="text-center">
                                <button class="btn btn-sm btn-outline-primary" title="Edit Akun" data-bs-toggle="modal" data-bs-target="#modalPemohon"><i class="fas fa-edit"></i></button>
                                <form action="#" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-outline-danger" title="Hapus Akun" onclick="return confirm('Apakah Anda yakin ingin menghapus akun pemohon ini?')"><i class="fas fa-trash"></i></button>
                                </form>
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="7" class="text-center py-5 text-muted">
                                <i class="fas fa-users-slash mb-3" style="font-size: 2rem; opacity: 0.5;"></i><br>
...
<!-- ==================== MODAL TAMBAH / EDIT PEMOHON ==================== -->
<div class="modal fade" id="modalPemohon" tabindex="-1" aria-labelledby="modalPemohonLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="modalPemohonLabel"><i class="fas fa-user-gear me-2 text-warning"></i> Form Akun Pemohon</h5>
            ...
            <form action="#" method="POST">
                ...
                <div class="modal-body bg-light">
                    <div class="card border-0 shadow-sm p-4">
                        ...
                        <div class="section-title mt-0"><i class="fas fa-id-card me-2"></i> Identitas Pemohon</div>
                        ...
                        <div class="section-title"><i class="fas fa-address-book me-2"></i> Informasi Kontak & Akses</div>
                        <div class="row g-3">
                            <div class="col-md-6">
