<?php
    ...
    /* ------------------------------------------------------------
       ...
       Dari controller kirim:
         ...
         $dataPenyelamatan : koleksi/array alat, tiap item punya id_pos, jenis_sarana, path_gambar
       ------------------------------------------------------------ */
    $posPemadam      = $posPemadam ?? [];
    $dataPenyelamatan = $dataPenyelamatan ?? [];
    ...
    $halaman_aktif  = '/informasi-penyelamatan';
...
<head>
    ...
    <meta name="description" content="Galeri publik alat dan sarana penyelamatan serta evakuasi di setiap pos Dinas Pemadam Kebakaran dan Penyelamatan Kota Jambi.">
    <title>Sarana penyelamatan | SIMERAH KOJA</title>
    ...
    <div class="wrap">
        <nav aria-label="Breadcrumb" class="rise">
            <ol class="crumbs">
                ...
                <li><a href="/informasi-layanan">Informasi layanan</a></li>
                <li><span aria-current="page">Sarana penyelamatan</span></li>
            </ol>
        </nav>
        <h1 class="rise d1">Informasi layanan</h1>
        <p class="rise d2">Galeri publik transparansi alat dan sarana penyelamatan di tiap pos.</p>
    </div>
</section>
    ...
    <div class="wrap">
        <div class="info-layout">
            ...
            <section class="data-col" aria-label="Galeri sarana pemeriksaan">
                ...
                <div class="data-head">
                    <div>
                        <h2>Sarana penyelamatan &amp; evakuasi</h2>
                        <p>Galeri publik transparansi alat dan sarana penyelamatan di tiap pos.</p>
                    </div>
                    <label class="search">
                        <span class="sr-only">Cari alat rescue</span>
                        <i class="fas fa-search"></i>
                        <input type="search" id="searchInput" placeholder="Cari alat rescue" autocomplete="off">
                    </label>
                </div>
                ...
                <?php foreach ($posPemadam as $i => $pos): $pos = $arr($pos); $posId = 'pos-' . $h($pos['id_pos'] ?? $i);
                    $itemsPos = [];
                    foreach ($dataPenyelamatan as $item) {
                        $item = $arr($item);
                        ...
                        <?php if ($itemsPos): ?>
                            ...
                            <div class="g-card" data-name="<?= $h(mb_strtolower($item['jenis_sarana'] ?? '')) ?>">
                                ...
                                <div class="g-body">
                                    ...
                                    <span class="g-badge"><i class="fas fa-circle-check"></i> Tersedia di pos ini</span>
                                </div>
                            </div>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <div class="gallery-empty">
                                ...
                                <h3>Data kosong</h3>
                                <p>Belum ada galeri alat penyelamatan untuk pos ini.</p>
                            </div>
                        <?php endif; ?>
