...
<head>
    ...
    <title>Informasi Sarana Penyelamatan - SIMERAH KOJA</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="data-container">
            ...
            <div class="header-card">
                <div>
                    <!-- Judul Diset Untuk Penyelamatan -->
                    <h2 class="data-title text-danger">SARANA PENYELAMATAN & EVAKUASI</h2>
                    <p class="text-muted mb-0" style="font-weight: 500;">Galeri publik transparansi alat dan sarana penyelamatan di setiap Pos.</p>
                </div>
                <div class="search-box">
                    <i class="fas fa-search"></i>
                    <input type="text" id="searchInput" placeholder="Cari alat rescue...">
                </div>
            </div>
                        ...
                        <div class="gallery-grid">
                                    ...
                                    <div class="gallery-img-wrapper">
                                        @if($item->path_gambar && file_exists(public_path($item->path_gambar)))
                                            <a href="{{ asset($item->path_gambar) }}" target="_blank" style="display:block; width:100%; height:100%;">
                                                <img src="{{ asset($item->path_gambar) }}" alt="Gambar Sarana Penyelamatan">
                                            </a>
                                        @else
                            ...
                            @empty
                                <div style="grid-column: 1 / -1; background: white; padding: 60px 20px; text-align: center; border-radius: 12px; border: 1px dashed #cbd5e1;">
                                    ...
                                    <p class="text-muted mb-0">Belum ada galeri alat penyelamatan untuk pos ini.</p>
                                </div>
                            @endforelse
                        </div>
