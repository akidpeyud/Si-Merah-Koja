...
<head>
    ...
    <title>Informasi Prasarana - SIMERAH KOJA</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="data-container">
            ...
            <div class="header-card">
                <div>
                    <!-- Judul Diset Untuk Prasarana -->
                    <h2 class="data-title text-danger">PRASARANA PEMADAM KEBAKARAN</h2>
                    <p class="text-muted mb-0" style="font-weight: 500;">Galeri publik transparansi data bangunan dan fasilitas fisik di setiap Pos.</p>
                </div>
                <div class="search-box">
                    <i class="fas fa-search"></i>
                    <input type="text" id="searchInput" placeholder="Cari fasilitas prasarana...">
                </div>
            </div>
                        ...
                        <div class="gallery-grid">
                            ...
                            @forelse($dataFilter as $item)
                                <div class="gallery-card data-row">
                                    <div class="gallery-img-wrapper">
                                        @if($item->path_gambar && file_exists(public_path($item->path_gambar)))
                                            <a href="{{ asset($item->path_gambar) }}" target="_blank" style="display:block; width:100%; height:100%;">
                                                <img src="{{ asset($item->path_gambar) }}" alt="Gambar Prasarana">
                                            </a>
                                        @else
                                    ...
                                    <div class="gallery-content">
                                        <div class="gallery-title data-name">{{ $item->jenis_prasarana }}</div>
                                        <div class="gallery-meta">
                                            @if($item->luas_bangunan)
                                                <span class="meta-badge"><i class="fas fa-expand-arrows-alt"></i> Luas: {{ $item->luas_bangunan }}</span>
                                            @else
                            ...
                            @empty
                                <div style="grid-column: 1 / -1; background: white; padding: 60px 20px; text-align: center; border-radius: 12px; border: 1px dashed #cbd5e1;">
                                    ...
                                    <p class="text-muted mb-0">Belum ada galeri prasarana untuk pos ini.</p>
                                </div>
                            @endforelse
                        </div>
