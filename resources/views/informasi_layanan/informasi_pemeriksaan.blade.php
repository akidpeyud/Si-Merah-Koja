<?php
    ...
    /* ------------------------------------------------------------
       ...
       Dari controller kirim:
         ...
         $dataPemeriksaan : koleksi/array alat, tiap item punya id_pos, jenis_sarana, path_gambar
       ------------------------------------------------------------ */
    ...
    $halaman_aktif  = '/informasi-pemeriksaan';
...
<head>
    ...
    <meta name="description" content="Galeri publik sarana pemeriksaan proteksi kebakaran di setiap pos Dinas Pemadam Kebakaran dan Penyelamatan Kota Jambi.">
    <title>Sarana pemeriksaan | SIMERAH KOJA</title>
    ...
    <div class="wrap">
        <nav aria-label="Breadcrumb" class="rise">
            <ol class="crumbs">
                ...
                <li><a href="/informasi-layanan">Informasi layanan</a></li>
                <li><span aria-current="page">Sarana pemeriksaan</span></li>
            </ol>
        </nav>
        <h1 class="rise d1">Informasi layanan</h1>
        <p class="rise d2">Galeri publik transparansi data ketersediaan alat pemeriksaan proteksi kebakaran di tiap pos.</p>
    </div>
</section>
            ...
            <section class="data-col" aria-label="Galeri sarana pemeriksaan">
                ...
                <div class="data-head">
                    ...
                    <label class="search">
                        ...
                        <input type="search" id="searchInput" placeholder="Cari alat pemeriksaan" autocomplete="off">
                    </label>
                </div>
                    ...
                    <div class="gallery">
                        ...
                        <?php else: ?>
                            <div class="gallery-empty">
                                ...
                                <h3>Data kosong</h3>
                                <p>Belum ada galeri alat pemeriksaan untuk pos ini.</p>
                            </div>
                        <?php endif; ?>
