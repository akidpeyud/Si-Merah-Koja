...
<head>
    ...
    <meta name="description" content="Informasi dan pemetaan kondisi jaringan hidrant yang tersebar di wilayah Kota Jambi.">
    <title>Data Hidrant Kota | SIMERAH KOJA</title>
    ...
    <div class="wrap">
        <nav aria-label="Breadcrumb" class="rise">
            <ol class="crumbs">
                ...
                <li><a href="/informasi-layanan">Informasi layanan</a></li>
                <li><span aria-current="page">Data Hidrant Kota</span></li>
            </ol>
        </nav>
        <h1 class="rise d1">Data Hidrant Kota Jambi</h1>
        <p class="rise d2">Informasi dan pemetaan kondisi jaringan hidrant yang tersebar di wilayah Kota Jambi.</p>
    </div>
</section>
                        ...
                        <table class="data-table">
                            <thead>
                                <tr>
                                    ...
                                    <th width="25%">JALAN / LOKASI TERDEKAT</th>
                                    <th width="20%">KEC/KELURAHAN</th>
                            ...
                            <tbody>
                                @forelse($dataMaintenance as $item)
                                    <tr>
                                        ...
                                        <td class="text-bold">
                                            {{ $item->jalan }}<br>
                                            <span style="font-weight:normal; font-size:0.85rem; color:var(--steel);">Terdekat: {{ $item->lokasi_terdekat ?? '-' }}</span>
                                        </td>
                                        <td>
                                            {{ $item->kecamatan }}<br>
