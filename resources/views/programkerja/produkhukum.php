...
<head>
    ...
    <title>Produk Hukum - Program Kerja | SIMERAH KOJA</title>
    ...
    <style>
        ...
        .pdf-card {
            ...
            text-decoration: none;
            text-align: center;
            padding: 20px 15px; /* Sedikit lebih ringkas untuk grid banyak */
            border-radius: 12px;
            transition: all 0.3s ease;
            background: #ffffff;
        ...
        .pdf-card img {
            width: 55px; /* Ikon diperkecil agar tidak makan tempat vertikal */
            height: auto;
            margin-bottom: 12px;
        ...
        .pdf-card h3 {
            font-size: 0.85rem; /* Font size disesuaikan untuk teks panjang */
            font-weight: 500;
            color: var(--text-dark);
            line-height: 1.4;
            margin: 0;
    ...
    <div class="container">
        <div class="main-container">
            ...
            <ul class="nav custom-tabs">
                ...
                <!-- TAB PRODUK HUKUM ACTIVE -->
                <li class="nav-item">
                    <a class="nav-link active" href="/produkhukum">
                        <i class="fas fa-folder-open"></i> PRODUK HUKUM
                    </a>
                </li>
            </ul>
            ...
            <div class="row g-4 align-items-stretch">
                ...
                <div class="col-lg-8 col-xl-9">
                    <div class="row g-3"> <!-- Gap diperkecil jadi g-3 agar muat lebih baik -->
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a href="#" target="_blank" class="pdf-card">
                                ...
                                <h3>Permen 11/PRT/M/ 2020 Tentang Tim Ahli Bangunan Gedung, Pengkaji Teknis, dan Penilik Bangunan</h3>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a href="#" target="_blank" class="pdf-card">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" alt="PDF">
                                <h3>Perwal No 9 Tahun 2019 Tentang PROTAP Penanggulangan Kebakaran dan Bencana Lainnya di Kota Jambi</h3>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a href="#" target="_blank" class="pdf-card">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" alt="PDF">
                                <h3>Permen PU 20 Tahun 2009 Tentang Pedoman Teknis Manajemen Proteksi Kebakaran di Perkotaan</h3>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a href="#" target="_blank" class="pdf-card">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" alt="PDF">
                                <h3>Permendagri No 16 Tahun 2020 Tentang Nomenklatur Dinas Pemadam Kebakaran</h3>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a href="#" target="_blank" class="pdf-card">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" alt="PDF">
                                <h3>Permen Tenaga Kerja No. 04/Men/1980 Tentang Syarat Pemasangan Alat Pemadam Api Ringan</h3>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a href="#" target="_blank" class="pdf-card">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" alt="PDF">
                                <h3>PERDA 3 TH 2015 Tentang BANGUNAN</h3>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a href="#" target="_blank" class="pdf-card">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" alt="PDF">
                                <h3>Permen PU 26 Tahun 2008 Tentang Pedoman Teknis Rencana Induk Sistem Proteksi Kebakaran</h3>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a href="#" target="_blank" class="pdf-card">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" alt="PDF">
                                <h3>Permendagri No 16 2009 Tentang Standar Aparatur Pemadaman Kebakaran di Daerah</h3>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a href="#" target="_blank" class="pdf-card">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" alt="PDF">
                                <h3>UU RI Nomor: 28 Tahun 2002 Tentang Bangunan Gedung</h3>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a href="#" target="_blank" class="pdf-card">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" alt="PDF">
                                <h3>UU RI Nomor: 24 Tahun 2007 Tentang Penanggulangan Bencana</h3>
                            </a>
                        </div>
