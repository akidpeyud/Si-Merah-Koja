...
<?php
    ...
    $tab_aktif = $tab_aktif ?? 'perencanaan';

    /*
      Daftar dokumen perencanaan (mis. Renstra, Renja, RKA). Setiap item:
      ['judul' => '...', 'url' => 'link berkas PDF'].
      Dari controller boleh kirim array atau koleksi model yang punya kolom judul dan url.
      Selama kosong, halaman menampilkan status "Belum ada dokumen".
    */
...
<<<<<<< HEAD
    <title>Perencanaan - Program Kerja | SIMERAH KOJA</title>
    ...
    <div class="container">
        <div class="main-container">
            ...
            <div class="row g-4 align-items-stretch">
                ...
                <!-- Kanan: Area Konten Perencanaan (Dikosongkan sesuai permintaan) -->
