...
<head>
    ...
    <title>Izin Penjualan - SIMERAH KOJA</title>
...
<body>
    ...
    <!-- DERETAN IKON KLIKABEL (Izin Penjualan yang Aktif) -->
    <div class="service-icons-container">
        ...
        <!-- Izin Penjualan (Aktif) -->
        <a href="/layanan-fasilitas/izin_penjualan" class="service-icon-link active">
            <div class="service-icon-box">
    ...
    <div class="content-wrapper">
        ...
        <div class="sidebar">
            ...
            <ul class="info-list">
                ...
                <li class="info-item">
                    ...
                    <div class="info-body">
                        <ul>
                            <li>Menginput Formulir Izin Penjualan Alat-alat Pencegahan, Pemadaman Kebakaran dan Penyelamatan secara elektronik melalui simerah.jambikota.go.id</li>
                            <li>Upload Surat Permohonan Bermaterai (<a href="#">Download Surat Permohonan</a>)</li>
                            <!-- POPUP LIHAT DETAIL -->
                            <li>Upload Detail Persyaratan Izin Penjualan Alat-alat Pencegahan, Pemadaman Kebakaran dan Penyelamatan Lainnya<br>
                ...
                <li class="info-item">
                    ...
                    <div class="info-body">
                        Surat Izin Penjualan Alat-alat Pencegahan, Pemadaman Kebakaran dan Penyelamatan
                    </div>
                </li>
        ...
        <div class="form-container">
            <h2 class="form-title">Izin Penjualan Alat-alat Pencegahan,<br>Pemadaman Kebakaran dan Penyelamatan</h2>
            <div class="decor-line"><i class="fas fa-circle"></i></div>
    ...
    <div id="modalPersyaratan" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-title">Detail Persyaratan Izin Penjualan Alat-alat Pencegahan, Pemadaman Kebakaran dan Penyelamatan Lainnya</div>
            <div class="modal-body">
                <ol>
                    ...
                    <li>Scan Asli Nomor Induk Berusaha (NIB) &amp; Surat Izin Usaha</li>
                    <li>Scan Asli hasil pemeriksaan laboratorium kebakaran dan penyelamatan</li>
                    <li>Scan Asli Surat Penunjukan Supplier dari distributor</li>
                    <li>Daftar Barang yang diperjualbelikan</li>
                    <li>Surat Pernyataan untuk melaporkan hasil penjualan dan pendistribusian alat pemadam kebakaran dan penyelamatan kepada Dinas Pemadam Kebakaran dan Penyelamatan Kota Jambi</li>
                </ol>
            </div>
