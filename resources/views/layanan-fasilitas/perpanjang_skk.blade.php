...
@php
    ...
    $tab_aktif = 'perpanjang_skk'; // KARENA INI HALAMAN PERPANJANG SKK
...
<<<<<<< HEAD
    <title>Layanan Perpanjang SKK - SIMERAH KOJA</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .modal { display: none; position: fixed; z-index: 10000; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.6); backdrop-filter: blur(4px); overflow-y: auto; }
        .modal-content { background-color: #ffffff; margin: 5% auto; padding: 30px 40px; border-radius: 12px; width: 80%; max-width: 800px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25); position: relative; animation: slideDown 0.4s ease-out; }
        @keyframes slideDown { from { transform: translateY(-30px); opacity: 0; } to { transform: translateY(0); opacity: 1; } }
        .close-btn { position: absolute; top: 20px; right: 25px; color: #9ca3af; font-size: 24px; font-weight: bold; cursor: pointer; transition: color 0.3s; }
        .close-btn:hover { color: #ef4444; }
        .modal-title { font-size: 22px; font-weight: 800; color: #1f2937; margin-bottom: 25px; padding-bottom: 15px; border-bottom: 2px solid #f3f4f6; }
        .modal-body ol { padding-left: 20px; color: #4b5563; }
        .modal-body li { margin-bottom: 15px; font-size: 13px; line-height: 1.8; }
        .modal-footer { margin-top: 30px; padding-top: 20px; border-top: 2px solid #f3f4f6; text-align: right; }
        .btn-tutup { background-color: #ef4444; color: white; padding: 10px 25px; border: none; border-radius: 6px; font-weight: 700; cursor: pointer; transition: background 0.3s; }
        .btn-tutup:hover { background-color: #dc2626; }
        .link-detail { color: #ef4444; text-decoration: none; cursor: pointer; font-weight: 600; }
...
=======
    ...
    <meta name="description" content="Ajukan perpanjangan Sertifikat Keamanan Kebakaran (SKK) secara daring di Dinas Pemadam Kebakaran dan Penyelamatan Kota Jambi.">
    <title>Perpanjang SKK - Layanan perizinan | SIMERAH KOJA</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .text-link { font: inherit; font-weight: 600; color: var(--signal-d); text-decoration: underline; text-underline-offset: 3px; cursor: pointer; }
...
<<<<<<< HEAD
    ...
    <div class="page-hero">
        ...
        <div class="breadcrumb">
            <a href="/">Home</a> <span>&raquo;</span> PERIZINAN <span>&raquo;</span> <span class="active">Perpanjang SKK</span>
        </div>
    </div>
    ...
    <div class="service-icons-container">
        ...
        <!-- Perpanjang SKK (Aktif) -->
        <a href="/layanan-fasilitas/perpanjang_skk" class="service-icon-link active">
            <div class="service-icon-box">
    ...
    <div class="content-wrapper">
        ...
        <div class="form-container">
            <h2 class="form-title">Perpanjang Sertifikat Keamanan Kebakaran</h2>
            <div class="decor-line"><i class="fas fa-circle"></i></div>
            ...
            <form action="{{ route('permohonan.perpanjang_skk.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <button type="submit" class="btn-submit"><i class="fas fa-paper-plane me-2"></i>KIRIM PERMOHONAN</button>
            </form>
        </div>
                ...
                <section class="side-card">
                    ...
                    <ol class="checklist">
                        <li>
                            ...
                            <div>Isi formulir Perpanjangan Sertifikat Keamanan Kebakaran secara elektronik melalui <strong>simerah.jambikota.go.id</strong></div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div>
                                Unggah detail persyaratan perpanjangan SKK lainnya
            ...
            <section class="form-panel" id="formulir" aria-label="Formulir permohonan">
                <div class="form-bar">
                    <div class="form-title">
                        ...
                        <div>
                            <h2>Formulir Perpanjang SKK</h2>
                            <p>Perpanjangan Sertifikat Keamanan Kebakaran</p>
                        </div>
                    </div>
                    <span class="form-note"><span class="req" aria-hidden="true">*</span> wajib diisi</span>
                </div>

                <form class="form-body" action="{{ route('permohonan.perpanjang_skk.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<dialog class="modal" id="modalPersyaratan" aria-labelledby="modalTitle">
    <div class="modal-head">
        <h2 id="modalTitle">Detail persyaratan Perpanjang SKK Lainnya</h2>
    ...
    <div class="modal-body">
        <ol class="req-list">
            ...
            <li>Scan asli Izin Mendirikan Bangunan (IMB)</li>
            <li class="req-key">
                <b>Scan Asli Sertifikat Keselamatan Kebakaran (SKK) 1 Tahun Terakhir</b>
            </li>
            <li class="req-key" style="background-color: #fefce8;">
                <b style="color: #ca8a04;">Scan Asli Sertifikat Layak Fungsi (SLF) Tahun Terakhir</b>
            </li>
            <li>Tanda Daftar Keahlian Keselamatan Kebakaran</li>
            <li>
