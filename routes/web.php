...
Route::get('/internal/pencegahan/peningkatan-kapasitas/diksar', function () {
    // Ambil data dari tabel tbl_diksar (pastikan nama tabel sesuai dengan database kamu)
    $data_diklat = \Illuminate\Support\Facades\DB::table('tbl_diksar')->orderBy('id', 'desc')->get();
    
    // Kirimkan variabel $data_diklat ke file view
...
// TAMBAHAN RUTE UNTUK TOMBOL TAMBAH DATA (MENGATASI 404)
Route::get('/internal/pencegahan/pemberdayaan-masyarakat/create', [App\Http\Controllers\PemberdayaanController::class, 'create'])->name('pemberdayaan.create');

// RUTE UNTUK MENYIMPAN DATA DARI FORM (Fungsi Submit)
Route::post('/internal/pencegahan/pemberdayaan-masyarakat/store', [App\Http\Controllers\PemberdayaanController::class, 'store'])->name('pemberdayaan.store');
...
// Menyimpan data ke database (yang punya name 'inspeksi.store')
...
// Modul Pelatihan Keluarga Tanggap Kebakaran (Damkar Goes to RT)
...
Route::get('/internal/pencegahan/pemberdayaan-masyarakat/pelatihan-keluarga/tambah', [App\Http\Controllers\PencegahanController::class, 'createPelatihanKeluarga'])->name('pelatihan_keluarga.create');
Route::post('/internal/pencegahan/pemberdayaan-masyarakat/pelatihan-keluarga/tambah', [App\Http\Controllers\PencegahanController::class, 'storePelatihanKeluarga'])->name('pelatihan_keluarga.store');
Route::get('/internal/pencegahan/pemberdayaan-masyarakat/pelatihan-keluarga/{id}/edit', [App\Http\Controllers\PencegahanController::class, 'editPelatihanKeluarga'])->name('pelatihan_keluarga.edit');
Route::put('/internal/pencegahan/pemberdayaan-masyarakat/pelatihan-keluarga/{id}', [App\Http\Controllers\PencegahanController::class, 'updatePelatihanKeluarga'])->name('pelatihan_keluarga.update');
Route::delete('/internal/pencegahan/pemberdayaan-masyarakat/pelatihan-keluarga/{id}', [App\Http\Controllers\PencegahanController::class, 'destroyPelatihanKeluarga'])->name('pelatihan_keluarga.destroy');
// =======================================================
// ROUTE PEMBERDAYAAN MASYARAKAT DAN DUNIA USAHA
// =======================================================
Route::get('/internal/pencegahan/pemberdayaan-masyarakat', function () {
